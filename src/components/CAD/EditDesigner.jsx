      ...
      const handleImageUpload = async (e) => {
        ...
        try {
          ...
          Swal.fire({
            ...
            text: "Your image is being processed. Please wait...",
          ...
          // Success alert after image is saved
          Swal.fire({
            icon: "success",
            title: "Image Saved",
            text: "The CAD image has been saved successfully.",
          });
      
          navigate("/cad_approval_list"); // Redirect after saving
        } catch (error) {
          console.error("Error creating Cad Image:", error.response ? error.response.data : error.message);
